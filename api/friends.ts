...
const router = Router();
const ROBLOX_FRIENDS_API_BASE_URL = 'https://friends.roblox.com';
...
router.use('/*', async (req: Request, res: Response) => {
    try {
        ...
        const robloxResponse = await axios({
            method: req.method,
            url: `${ROBLOX_FRIENDS_API_BASE_URL}/${endpoint}`,
            headers: {
                ...req.headers as AxiosRequestHeaders,
                host: 'friends.roblox.com', // Ensure the correct host header
            },
            data: req.body,
        });
